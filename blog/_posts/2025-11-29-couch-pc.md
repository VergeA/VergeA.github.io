...
* __CPU Cooler: Noctua L9x65.__ This is the only part I'm a little dubious about. It's not really intended for high-power CPUs. But if I'm run the CPU in ECO mode it's probably fine?
...
1. If I'm getting a bigger case, I might as well get a bigger CPU cooler, and then I don't even need to run the processor in ECO mode. I grabbed a [Thermalright Phantom Spirit 120](https://www.thermalright.com/product/phantom-spirit-120-se/) for $40, which essentially the king of budget air coolers. 
